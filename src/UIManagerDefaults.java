...
public class UIManagerDefaults implements ActionListener, ItemListener {
    ...
    private JMenu createLAFMenu() {
        ...
        for (int i = 0; i < lafInfo.length; i++) {
            ...
            addLaf(laf, name, menu, bg, lafId);
        }

        addLaf("com.formdev.flatlaf.FlatIntelliJLaf", "FlatIntelliJLaf", menu, bg, lafId);
        addLaf("com.formdev.flatlaf.FlatLightLaf", "FlatLightLaf", menu, bg, lafId);
        addLaf("com.formdev.flatlaf.FlatDarkLaf", "FlatDarkLaf", menu, bg, lafId);

        return menu;
    }

    private void addLaf(String laf, String name, JMenu menu, ButtonGroup bg, String lafId) {
...
//				System.out.println(e.getStackTrace()[0]);
    ...
    private static void createAndShowGUI() {
        ...
        try {
            frame.setIconImage(ImageIO.read(new File("/icon-gui.png")));
        } catch (IOException ex) {
            Logger.getLogger(UIManagerDefaults.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Falha ao Carregar LookAndFeel!");
        }
